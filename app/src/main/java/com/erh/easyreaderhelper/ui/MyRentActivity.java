...
public class MyRentActivity extends AppCompatActivity {
    ...
    private LostAndFoundAdapter myrentAdapter;
    ...
    private void initViews() {
        ...
        recyclerView = (RecyclerView)findViewById(R.id.myrent_revy);
        recyclerView.setLayoutManager(new LinearLayoutManager(MyRentActivity.this, LinearLayoutManager.VERTICAL, false));
        // myPublishedAdapter = new MyPublishedAdapter(MyPublishedActivity.this);
        myrentAdapter = new LostAndFoundAdapter(MyRentActivity.this);
    }
